import { CodeUnstyled } from "@ui/components/code-unstyled";
...
const components = {
  h1: ({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) => (
    <h1
      className={cn(
        "font-heading mt-2 scroll-m-20 text-4xl font-bold mt-8",
        className
      )}
      {...props}
    />
  ...
  code: (props: ComponentProps<"code">) => (
    <code {...props} className="text-xs mt-2 p-2 font-mono overflow-x-auto">
      {props.children}
    </code>
  )
};
